...
const inventoryModules: InventoryModule[] = [
  {
    ...
    description:
      "Monitor inventory size, active inventory, drafts, stock risk and inventory value.",
    features: 10,
    icon: Package,
    metric: "7",
  ...
  },
  {
    ...
    description:
      "Create, edit, organise and publish the complete KRVE inventory operations.",
    features: 12,
    icon: ShoppingBag,
    metric: "7",
    metricLabel: "Inventory items",
  },
  {
    id: "product-variants",
    ...
    icon: Layers3,
    metric: "24",
    metricLabel: "Available variants",
  },
  {
    id: "collections",
    title: "Warehouses",
    ...
    icon: Boxes,
    metric: "6",
    metricLabel: "Warehouses",
  },
  {
    id: "categories",
    title: "Purchase Orders",
    description:
      "Manage product categories, subcategories and inventory hierarchy.",
    features: 10,
    icon: Tags,
    metric: "12",
  ...
  },
  {
    ...
    title: "Low Stock",
    description:
      "Review inventory below reorder level and initiate stock replenishment.",
    features: 9,
    icon: AlertTriangle,
    metric: "2",
    metricLabel: "Low-stock inventory",
  },
  {
    id: "out-of-stock",
    title: "Incoming Stock",
    description:
      "Monitor unavailable inventory and restore product availability.",
    features: 9,
    icon: X,
    metric: "1",
    metricLabel: "Unavailable inventory",
  },
  {
    id: "draft-inventory",
    title: "Stock Adjustments",
    description:
      "Review incomplete inventory before approval and publication.",
    features: 10,
    icon: PackageOpen,
    metric: "1",
  ...
  },
  {
    ...
    description:
      "Generate inventory, pricing, inventory and product-performance reports.",
    features: 10,
    icon: FileBarChart,
    metric: "14",
...
const workspaceContent: Record<string, WorkspaceContent> = {
  "inventory-dashboard": {
    ...
    title: "Inventory Dashboard",
    description:
      "Manage the complete KRVE inventory operations, variants, categories, collections, pricing, inventory and publishing channels.",
    primaryAction: "Sync Inventory",
    secondaryAction: "Stock In",
    statistics: [
      { label: "Total Stock Units", value: "7", note: "Complete inventory" },
      { label: "Available", value: "5", note: "Published inventory" },
      { label: "Reserved Stock", value: "1", note: "Not yet published" },
    ...
    workflows: [
      ...
      {
        title: "Variant & Inventory Valuation",
        description:
      ...
      },
      {
        ...
        description:
          "Publish approved inventory to website, app and marketplace channels.",
      },
    ],
  },
  "stock-overview": {
    ...
    primaryAction: "Sync Inventory",
    secondaryAction: "Add Inventory Item",
    statistics: [
      { label: "Inventory Items", value: "7", note: "All KRVE inventory" },
      { label: "Published", value: "5", note: "Visible to customers" },
      { label: "Reserved Stock", value: "1", note: "Pending completion" },
  ...
  "reserved-stock": {
    ...
    title: "Reserved Stock",
    description:
      "Track stock and warehouse stock across warehouses and sales channels.",
    primaryAction: "Sync Inventory",
    secondaryAction: "Adjust Stock",
    statistics: [
      { label: "Units Available", value: "149", note: "Across all inventory" },
      { label: "Low Stock", value: "2", note: "Reorder required" },
      { label: "Incoming Stock", value: "1", note: "Unavailable product" },
      { label: "Inventory Cost Value", value: "₹7,85,500", note: "Current valuation" },
    ],
    workflows: [
      {
  ...
  pricing: {
    eyebrow: "Commercial Inventory Valuation",
    title: "Inventory Valuation",
    description:
      "Manage product cost, selling price, margins, discounts and price publication.",
    primaryAction: "Update Inventory Valuation",
    secondaryAction: "Reports Price List",
    statistics: [
      { label: "Inventory Cost Value", value: "₹7,85,500", note: "Current stock value" },
      { label: "Average Margin", value: "42%", note: "Across active inventory" },
      { label: "Price Changes", value: "3", note: "Pending approval" },
      { label: "Discounted Inventory", value: "2", note: "Current campaigns" },
    ],
    workflows: [
      {
...
export default function InventoryManagement() {
  const [activeModuleId, setAvailableModuleId] = useState<string | null>(null);
  ...
  const filteredModules = useMemo(() => {
    ...
    return inventoryModules.filter((module) =>
      `${module.title} ${module.description}`.toLowerCase().includes(query),
    );
  }, [searchQuery]);

  const activeModule =
    inventoryModules.find((module) => module.id === activeModuleId) ?? null;
  ...
  if (activeModule) {
    return (
      <>
        <InventoryWorkspace
          module={activeModule}
          onBack={() => setAvailableModuleId(null)}
          onSync={() => setShowSyncModal(true)}
          onAdd={() => setShowAddItemModal(true)}
        />

        {showSyncModal && (
          <SyncInventoryModal onClose={() => setShowSyncModal(false)} />
        )}

        {showAddItemModal && (
          <AddInventoryItemModal onClose={() => setShowAddItemModal(false)} />
        )}
      </>
    );
  }
      ...
      <div className="p-4 sm:p-6 lg:p-8">
          ...
          <div className="flex flex-col justify-between gap-7 xl:flex-row xl:items-center">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 max-w-3xl text-sm leading-7 text-blue-100">
                Control stock levels, warehouse movements, purchase orders, suppliers, valuation, replenishment and inventory intelligence across KRVE.
              </p>
            </div>
        ...
        <section className="mt-6 grid gap-5 sm:grid-cols-2 xl:grid-cols-6">
          <SummaryCard
            ...
            value="393"
            description="320 available for fulfilment"
            icon={Package}
          ...
          <SummaryCard
            title="Available"
            value="₹12,33,500"
            description="Retail potential ₹30,63,107"
            icon={PackageCheck}
          ...
          <SummaryCard
            title="Low Stock"
            value="142"
            description="2 active purchase orders"
            icon={AlertTriangle}
          ...
          <div className="flex flex-col justify-between gap-4 xl:flex-row xl:items-end">
            <div>
              ...
              <h2 className="mt-2 text-2xl font-black text-slate-950">
                Inventory Operations Modules
              </h2>

              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
                Open a module to manage its complete inventory and inventory workflow.
              </p>
            </div>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {filteredModules.map((module) => (
              <InventoryModuleCard
                key={module.id}
                module={module}
                onOpen={() => setAvailableModuleId(module.id)}
              />
            ))}
          </div>
        </section>
      ...
      statistics: [
        {
          ...
          value: module.metric,
          note: "Current inventory status",
        },
        { label: "Available Records", value: "5", note: "Currently published" },
        { label: "Pending Actions", value: "2", note: "Require review" },
        { label: "Inventory Health", value: "96%", note: "Within target" },
      ],
      workflows: [
        {
          title: "Product Configuration",
          description:
            "Manage inventory records, attributes, media and organisation.",
        },
        {
          title: "Inventory Valuation & Inventory",
          description:
      ...
      <section className="mt-6 grid gap-6 xl:grid-cols-[1.25fr_0.75fr]">
        ...
        <article className="rounded-3xl bg-[#0f172a] p-6 text-white shadow-xl">
          ...
          <h2 className="mt-6 text-xl font-black">
            KRVE AI Inventory Insight
          </h2>

          <p className="mt-3 text-sm leading-7 text-slate-400">
            Inventory health is stable. Two low-stock inventory and one unavailable
            product require inventory action.
          </p>

          <div className="mt-6 space-y-3">
            <InsightRow label="Available inventory" value="5" />
...
function SyncInventoryModal({ onClose }: { onClose: () => void }) {
  const [synced, setSynced] = useState(false);

  return (
    <ModalShell
      title="Sync Inventory"
      description="Synchronise inventory data across connected commerce channels."
      icon={RefreshCw}
      onClose={onClose}
      maxWidth="max-w-2xl"
    >
        ...
        <div className="mt-5 rounded-2xl border border-blue-200 bg-blue-50 p-5">
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm leading-6 text-blue-700">
              KEOS will synchronise inventory information, pricing, stock and publishing status.
            </p>
          </div>
        </div>
...
function AddInventoryItemModal({ onClose }: { onClose: () => void }) {
  const [saved, setSaved] = useState(false);

  return (
    <ModalShell
      title="Add Inventory Item"
      description="Create a new KRVE inventory product."
      icon={Plus}
      onClose={onClose}
      maxWidth="max-w-4xl"
    >
      <div className="max-h-[65vh] overflow-y-auto p-6">
        <div className="grid gap-5 md:grid-cols-2">
          <FormField label="Inventory Item" placeholder="Enter product name" />
