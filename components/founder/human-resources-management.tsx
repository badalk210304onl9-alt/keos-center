          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              >
                ...
                <option>Luxury Catalog</option>
                <option>People Ops (HR)</option>
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-xl border border-slate-200 bg-slate-50 p-2.5 text-xs text-slate-900 outline-none focus:border-blue-500"
              >
                <option>AI Technical Team</option>
                <option>Catalog Executive</option>
                <option>Support & CRM Lead</option>
                <option>HR Operations Lead</option>
              </select>
            </div>
          </div>
